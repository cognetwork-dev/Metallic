        ...
        */
        ...
        for (let i = 0;; i++) {
            if ('host' in headers)
                ...
                headers.Host = urlO.host;
            const response = await this.request(req.method, headers, req.body, urlO.protocol, urlO.hostname, resolvePort(urlO), urlO.pathname + urlO.search, req.cache, req.signal);
...
export { BareError, createBareClient, BareClient as default, statusEmpty, statusRedirect };
