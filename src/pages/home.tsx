...
function Home() {
	...
	const [searchEngine] = useGlobalState<string>(
		"engine",
		localStorage.getItem("metallic/engine") || searchEngineData.google
	);
	const [openUsing] = useGlobalState<string>(
		"open",
		localStorage.getItem("metallic/open") || "default"
	);
	...
	return (
		<>
			...
			<div class="flex flex-col items-center justify-center">
				<div
					class={
						"bg-secondary w-[600px] h-14 flex items-center justify-center" +
						(suggestions.length ? " rounded-[28px_28px_0_0]" : " rounded-full")
					}
				>
				...
				<div
					class={
						"bg-secondary rounded-[0_0_28px_28px] w-[600px]" +
				...
				>
					{suggestions.map((suggestion: string) => (
						<div
							...
							class="h-14 flex items-center cursor-pointer px-4 select-none text-textInverse"
							key={suggestion}
						>
